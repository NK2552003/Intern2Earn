    ...
    <div className="min-h-screen bg-[#05040f]">
      ...
      <section className="relative overflow-hidden py-12 sm:py-16 md:py-24 lg:py-32 px-4 sm:px-6 lg:px-8">
        <div className="absolute inset-0 -z-10 overflow-hidden">
          <motion.div
            className="absolute top-10 -left-20 sm:top-20 sm:left-10 w-40 h-40 sm:w-72 sm:h-72 bg-violet-500/10 rounded-full mix-blend-multiply filter blur-3xl"
            animate={{ y: [0, 30, 0] }}
            transition={{ duration: 8, repeat: Infinity }}
          />
          <motion.div
            className="absolute top-20 -right-20 sm:top-40 sm:right-10 w-40 h-40 sm:w-72 sm:h-72 bg-violet-500/15/10 rounded-full mix-blend-multiply filter blur-3xl"
            animate={{ y: [30, 0, 30] }}
        ...
        <div className="max-w-4xl mx-auto text-center">
          <motion.div variants={itemVariants} initial="hidden" animate="visible">
            <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 rounded-full bg-violet-500/10 border border-violet-500/20 mb-4 sm:mb-6">
              ...
              <span className="text-xs sm:text-sm font-medium text-violet-400">About Upskillify</span>
            </div>
      ...
      {/* Mission & Vision */}
      <section className="bg-white/5 border-y border-white/8 py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <motion.div variants={itemVariants} className="p-6 sm:p-8 rounded-xl border border-white/8 bg-[#05040f]">
            ...
            <motion.div variants={itemVariants} className="p-6 sm:p-8 rounded-xl border border-white/8 bg-[#05040f]">
              <Award className="w-12 h-12 text-violet-400 mb-4" />
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-white/60">The principles that guide everything we do</p>
          </motion.div>
          ...
          >
            {[
              ...
              <motion.div
                key={idx}
                variants={itemVariants}
                className="p-6 rounded-xl border border-white/8 hover:border-violet-400/30 transition-all text-center"
              >
                <value.icon className="w-10 h-10 text-violet-400 mx-auto mb-4" />
      ...
      <section className="bg-white/5 border-y border-white/8 py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4">Our Team</h2>
            <p className="text-base sm:text-lg text-white/60">Meet the people building Upskillify</p>
          </motion.div>
          ...
          >
            {team.map((member, idx) => (
              <motion.div
                ...
                variants={itemVariants}
                whileHover={{ y: -5 }}
                className="p-6 rounded-xl border border-white/8 text-center hover:border-violet-400/30 transition-all"
              >
      ...
      <section className="bg-linear-to-r from-primary/10 to-accent/10 border-t border-white/8 py-12 sm:py-16 md:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div variants={itemVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            <p className="text-base sm:text-lg text-white/60 mb-8">Be part of something bigger. Transform careers. Create opportunities.</p>
